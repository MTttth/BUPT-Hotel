    ...
    <el-card class="login-card" shadow="hover">
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="80px" class="login-form" @submit.prevent>
        <el-form-item label="管理员ID" prop="username">
          <el-input v-model="form.username" placeholder="请输入管理员ID" prefix-icon="el-icon-user" />
        </el-form-item>
...
const rules = {
  username: [{ required: true, message: '请输入管理员ID', trigger: 'blur' }],
